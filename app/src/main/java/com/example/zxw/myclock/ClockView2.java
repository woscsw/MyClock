 ...
 * 自定义时钟View
 */
public class ClockView2 extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    private Handler handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            if (onTimeChangeListener != null) {
                onTimeChangeListener.onTimeChange(ClockView2.this, mHour, mMinute, mSecond);
            }
            return false;
        }
    });
